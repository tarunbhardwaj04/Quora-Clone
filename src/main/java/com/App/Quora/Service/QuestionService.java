...
public class QuestionService {
    ...
    public Page<?> search(String questionTitle, String topicName) {
        ...
        if (questionTitle != null && topicName != null) {
            return questionRepository.findByTitleContainingIgnoreCaseAndTopic_NameContainingIgnoreCase(questionTitle,
                    topicName, pageable);
        } else if (questionTitle != null) {
            return questionRepository.findByTitleContainingIgnoreCase(questionTitle, pageable);
        } else if (topicName != null) {
            return questionRepository.findByTopic_NameContainingIgnoreCase(topicName, pageable);
        }
